...
//        List<DhPerson> list = new ArrayList<>();
...
//        getDES();
    ...
    private static void getDES() throws Exception {
        ...
        byte[] result = cipher.doFinal("18857291195".getBytes());//输入要加密的内容
...
//        System.out.println("待办消息确认:"+jsonObject);
    ...
    public static void getSmsNews() throws KeyManagementException, NoSuchAlgorithmException, IOException{
        byte[] post = post(TODONEWS_URL + getAccesstoken(), getParams("待办测试", "5a41b292e4b058cf3d0cf314",
                "5cd8ba86e4b08d7338478e79"), charset);
        String a = new String(post);
        JSONObject jsonObject = JSONObject.parseObject(a);
...
//        System.out.println("accessToken: "+accessToken);
    ...
    public static String getParams(String content,String fromOpenId,String toOpenId) throws KeyManagementException, NoSuchAlgorithmException, IOException{
        JSONObject params = new JSONObject();
        params.put("content", content);
        params.put("title", "待办测试");
        params.put("itemtitle", "拜访审批");
        params.put("headImg", "https://www.yunzhijia.com/space/c/photo/load?id=5a2f7ad750f8dd7810e79981");
        params.put("appId", "500065577");
        params.put("senderId", fromOpenId);
        params.put("url", getNewsHandle(toOpenId));

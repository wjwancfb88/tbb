...
public class Encodes {
	...
	public static String md5(String s){
		try {
			return encodeHex(Digests.md5(new StringBufferInputStream(s)));
		} catch (IOException e) {
			e.printStackTrace();
			return null;
		}
	 ...
	 * Base62编码。
	 */
	public static String encodeBase36(byte[] input) {
		char[] chars = new char[input.length];
		for (int i = 0; i < input.length; i++) {
	...
	public static void main(String[] args){
		System.out.println(encodeBase64("963f5c14592a591a699483ca".getBytes()));

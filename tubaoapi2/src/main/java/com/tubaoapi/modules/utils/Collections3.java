...
public class Collections3 {
	...
	public static List extractToList(final Collection collection, final String propertyName,boolean includeNull) {
	...
	public static Set extractToSet(final Collection collection, final String propertyName) {
		return extractToSet(collection, propertyName, false);
	}
	
	
	public static Set extractToSet(final Collection collection, final String propertyName,boolean includeNull) {
		Set set = new HashSet();
		try {
			for (Object obj : collection) {
				Object value = PropertyUtils.getProperty(obj, propertyName);

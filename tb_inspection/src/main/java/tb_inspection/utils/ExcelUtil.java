...
import tb_inspection.entity.CommonEntity;
...
//            sh.addMergedRegion(new CellRangeAddress(0,0,0,headList.length - 1));
            ...
            for (; m < totalPage; m++) {
                ...
                for (int resultIndex = 0; resultIndex < resultList.size(); resultIndex++) {
                    ...
                    E entity1 = resultList.get(resultIndex);
                    Dh_inspectionEntity entity = (Dh_inspectionEntity)entity1;
//                    Date creattime = entity.getCreattime();
...
//                    }
                    ...
                    if ("1".equals(entity.getFfmcresult())){
                        entity.setFfmcresult("正常");
                    }else if ("0".equals(entity.getFfmcresult())){
                        entity.setFfmcresult("异常");
                    }
                    if ("1".equals(entity.getFfmpresult())){
                        entity.setFfmpresult("正常");
                    }else if ("0".equals(entity.getFfmpresult())){
                        entity.setFfmpresult("异常");
                    }
                    if ("1".equals(entity.getIffmcresult())){
                        entity.setIffmcresult("正常");
                    }else if ("0".equals(entity.getIffmcresult())){
                        entity.setIffmcresult("异常");
                    }
                    if ("1".equals(entity.getIffmmresult())){
                        entity.setIffmmresult("正常");
                    }else if ("0".equals(entity.getIffmmresult())){
                        entity.setIffmmresult("异常");
                    }
                    if ("1".equals(entity.getIfofmcresult())){
                        entity.setIfofmcresult("正常");
                    }else if ("0".equals(entity.getIfofmcresult())){
                        entity.setIfofmcresult("异常");
                    }
                    if ("1".equals(entity.getScresult())){
                        entity.setScresult("正常");
                    }else if ("0".equals(entity.getScresult())){
                        entity.setScresult("异常");
                    }
                    if ("1".equals(entity.getIffmsresult())){
                        entity.setIffmsresult("正常");
                    }else if ("0".equals(entity.getIffmsresult())){
                        entity.setIffmsresult("异常");
                    }
                    if ("1".equals(entity.getSfaresult())){
                        entity.setSfaresult("正常");
                    }else if ("0".equals(entity.getSfaresult())){
                        entity.setSfaresult("异常");
                    }
                    if ("1".equals(entity.getSpresult())){
                        entity.setSpresult("正常");
                    }else if ("0".equals(entity.getSpresult())){
                        entity.setSpresult("异常");
                    }
                    if ("1".equals(entity.getTfmcresult())){
                        entity.setTfmcresult("正常");
                    }else if ("0".equals(entity.getTfmcresult())){
                        entity.setTfmcresult("异常");
                    }
                    if ("1".equals(entity.getTfmlresult())){
                        entity.setTfmlresult("正常");
                    }else if ("0".equals(entity.getTfmlresult())){
                        entity.setTfmlresult("异常");
                    }
                    if ("1".equals(entity.getIfofmpresult())){
                        entity.setIfofmpresult("正常");
                    }else if ("0".equals(entity.getIfofmpresult())){
                        entity.setIfofmpresult("异常");
                    }
                    if ("1".equals(entity.getTfmmresult())){
                        entity.setTfmmresult("正常");
                    }else if ("0".equals(entity.getTfmmresult())){
                        entity.setTfmmresult("异常");
                    }
                    if ("1".equals(entity.getTfmsresult())){
                        entity.setTfmsresult("正常");
                    }else if ("0".equals(entity.getTfmsresult())){
                        entity.setTfmsresult("异常");
                    }
                    if ("1".equals(entity.getTftcsresult())){
                        entity.setTftcsresult("正常");
                    }else if ("0".equals(entity.getTftcsresult())){
                        entity.setTftcsresult("异常");
                    }
                    if ("1".equals(entity.getTftccresult())){
                        entity.setTftccresult("正常");
                    }else if ("0".equals(entity.getTftccresult())){
                        entity.setTftccresult("异常");
                    }
                    if ("1".equals(entity.getTftclresult())){
                        entity.setTftclresult("正常");
                    }else if ("0".equals(entity.getTftclresult())){
                        entity.setTftclresult("异常");
                    }
                    if ("1".equals(entity.getTftcmresult())){
                        entity.setTftcmresult("正常");
                    }else if ("0".equals(entity.getTftcmresult())){
                        entity.setTftcmresult("异常");
                    }

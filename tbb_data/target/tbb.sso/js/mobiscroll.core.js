    ...
    function Scroller(elem, settings) {
        ...
        function generateWheelItems(i) {
            ...
            for (j in warr[i]) {
                ...
                html += '<div class="dw-li dw-v" data-val="' + j + '" style="height:' + hi + 'px;line-height:' + hi + 'px;"><div class="dw-i">' + warr[i][j] + ri +'</div></div>';
                l++;
            }
            html += '</div>';
            return html;
        ...
        */
        that.show = function (prevAnim) {
            ...
            for (i = 0; i < s.wheels.length; i++) {
                ...
                html += '<div class="dwc' + (s.mode != 'scroller' ? ' dwpm' : ' dwsc') + (s.showLabel ? '' : ' dwhl') + '" style="width:' + bcbc + ';"><div class="dwwc dwrc"><table cellpadding="0" cellspacing="0" style="width:100%;"><tr>';
                // Create wheels
                for (label in s.wheels[i]) {
                    warr[l] = s.wheels[i][label];
                    html += '<td style="width:33%;"><div class="dwwl dwrc dwwl' + l + '">' + (s.mode != 'scroller' ? '<div class="dwwb dwwbp" style="height:' + hi + 'px;line-height:' + hi + 'px;"><span>+</span></div><div class="dwwb dwwbm" style="height:' + hi + 'px;line-height:' + hi + 'px;"><span>&ndash;</span></div>' : '') + '<div class="dwl">' + label + '</div><div class="dww" style="height:' + (s.rows * hi) + 'px;"><div class="dw-ul">';
                    // Create wheel values
            ...
            if (s.display != 'inline') {
                // Init buttons
                that.tap($('.dwb-s span', dw), function (e) {
                ...
                that.tap($('.dwb-c span', dw), function (e) {
                	that.cancel();

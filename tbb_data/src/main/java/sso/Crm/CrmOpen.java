...
//            response.sendRedirect("http://tbb.wisecrm365.cn/user/login?token="+CrmToken.getToken(jobno));
            response.sendRedirect("https://crm.tubaobao.com/user/login?token="+CrmToken.getToken(jobno));

...
public class CrmToken {
    private static final Log LOG = LogFactory.getLog(CrmToken.class);
    ...
    public static  String getToken(String username)throws ClientProtocolException, IOException {
        ...
        String apiUrl = CrmToken.signUrl("user/login-token", params);
        JSONObject r = CrmToken.apiGet(apiUrl);
